package net.redlinesoft.app.nickokitchen;
...
import net.redlinesoft.app.nickokitchen.R;
...
public class MainActivity extends Activity {
	...
	String url = "http://query.yahooapis.com/v1/public/yql?q=select%20title.content%2C%20link.href%20from%20feed%20where%20url%3D%22https%3A%2F%2Fgdata.youtube.com%2Ffeeds%2Fapi%2Fusers%2Frobjnixon%2Fuploads%3Fmax-results%3D50%22%20and%20link.rel%3D%22alternate%22&format=json&callback=";
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (checkNetworkStatus()) {
			...
			// Create the adView
			adView = new AdView(this, AdSize.SMART_BANNER, "a15116c1016ca78");
